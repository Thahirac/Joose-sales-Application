...
import 'package:joosesales/cubit/redeeM/redeem_cubit.dart';
...
class Redeem_Details extends StatefulWidget {
  final String? skey;
  const Redeem_Details({Key? key, this.skey}) : super(key: key);

  @override
  _Redeem_DetailsState createState() => _Redeem_DetailsState();
}

class _Redeem_DetailsState extends State<Redeem_Details> {
  ...
  void initState() {
    ...
    super.initState();
    redeemCubit.redeemdetails(widget.skey);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: JooseText(
          text:  AppLocalizations.of(context).translate("REDEEM DETAILS"),
  ...
  Widget detailsform() {
    ...
    if(pdetails==null){
      ...
      var tempDate = pdetails?.purchaseDate == null
          ? "0000-00-00 00:00:00"
          : pdetails?.purchaseDate;
      var correct = DateUtil().formattedDate(DateTime.parse(tempDate!));
      var tempDate1 = pdetails?.updatedAt == null
          ? "0000-00-00 00:00:00"
          : pdetails?.updatedAt;
    ...
    return Column(
      children: [
        SizedBox(
         ...
         Center(
          child: JooseText(
            text: AppLocalizations.of(context).translate("No Redeem found Here"),
            fontColor: Colors.black,
            fontWeight: FontWeight.w600,
            fontSize: 20,
          ),
